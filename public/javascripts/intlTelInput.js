...
(function(factory) {
    ...
    return function() {
        ...
        var defaults = {
            ...
            preferredCountries: [ "pt", "es", "fr", "de", "it", "gb", "us" ],
        ...
        function() {
            ...
            _createClass(Iti, [ {
                ...
                value: function getExtension() {
                    if (window.intlTelInputUtils) {
                        console.log(intlTelInputUtils.getExtension(this._getFullNumber(), this.selectedCountryData.iso2));
                ...
                value: function getNumber(format) {
                    if (window.intlTelInputUtils) {
                        ...
                        console.log(intlTelInputUtils.formatNumber(this._getFullNumber(), iso2, format));
